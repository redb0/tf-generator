...
class UiMainWindow:
    ...
    def setup_ui(self, main_window):
        ...
        self.constraints_high = QtWidgets.QLineEdit()
        # self.constraints_x1.setMaximumWidth(100)
        self.constraints_x2_label = QtWidgets.QLabel()
        self.constraints_down = QtWidgets.QLineEdit()
        ...
        form_2.addRow(self.constraints_x1_label, self.constraints_high)
        form_2.addRow(self.constraints_x2_label, self.constraints_down)
        ...
        self.max_func_coord = QtWidgets.QLineEdit()
        ...
        h_box_1.addWidget(self.max_func_coord)
        h_box_1.addWidget(self.max_func)

        # self.max_func.setMaximumWidth(100)
        self.min_label = QtWidgets.QLabel()
        self.min_func_coord = QtWidgets.QLineEdit()
        ...
        h_box_2.addWidget(self.min_func_coord)
        h_box_2.addWidget(self.min_func)
        ...
        form_3.addRow(self.min_label, h_box_2)
        form_3.addRow(self.max_label, h_box_1)
    ...
    def retranslate_ui(self, main_window):
        ...
        self.constraints_x1_label.setText(self.translate("MainWindow", "Ограничения сверху (x1, x2)"))
        self.constraints_x2_label.setText(self.translate("MainWindow", "Ограничения снизу (x1, x2)"))
        ...
        self.constraints_high.setText(self.translate("MainWindow", "6, 6"))
        self.constraints_down.setText(self.translate("MainWindow", "-6, -6"))
